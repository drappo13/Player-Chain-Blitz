...
const ROUND5_CORNERS: CornerGoal[] = [
  ...
  },
  {
    ...
    reveal: "Arsenal's 16th corner goal of the season — breaking the all-time PL record. Pedro Neto was sent off for protesting. Schmeichel, whose 1999 UCL win ended with two corner routines, called it 'a travesty'.",
  },
  {
    scorer: "TBD",
