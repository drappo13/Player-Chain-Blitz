...
const ROUND5_CORNERS: CornerGoal[] = [
  ...
  },
  {
    ...
    reveal: "Ben White scored twice in Chelsea's heaviest ever defeat to Arsenal, including this header from an Ødegaard corner. Havertz also got a brace. Five goals in 18 second-half minutes.",
  },
  {
    scorer: "Eberechi Eze",
        ...
        {phase === "intro" && (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4 h-screen justify-center">
              ...
              {/* DEV jump-to-round panel only renders in local dev builds,
                  hidden on drapk.in. To use locally: npm run dev. */}
              {import.meta.env.DEV && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
